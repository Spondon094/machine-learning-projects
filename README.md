...
Applied machine learning on real-world datasets, with emphasis 
on rigorous feature engineering, temporal validation, and 
...
> Predicting total income and expenses for 10,000 N26 bank 
> users from transaction history.

| | |
|---|---|
| 📊 **Dataset** | 408,546 transactions across 10,000 users |
| 🔀 **Approach** | Temporal split — Feb–May features → Jun–Jul targets |
| 🛠️ **Features** | 56 features across 5 groups |
